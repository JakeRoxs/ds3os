...
bool SettingsHandler::IsWeaponLevelMatchingDisabled() {
  ...
  return Config.SummonSignMatchingParameters.DisableWeaponLevelMatching ||
...
bool SettingsHandler::IsSoulLevelMatchingDisabled() {
  ...
  return Config.SummonSignMatchingParameters.DisableLevelMatching ||
...
bool SettingsHandler::IsSoulMemoryMatchingDisabled() {
  ...
  return Config.DS2_WhiteSoapstoneMatchingParameters.DisableSoulMemoryMatching ||
