...
DS3_QuickMatchManager::DS3_QuickMatchManager(Server* InServerInstance, GameService* InGameServiceInstance)
    : ServerInstance(InServerInstance), GameServiceInstance(InGameServiceInstance) {
}
...
MessageHandleResult DS3_QuickMatchManager::Handle_RequestRegisterQuickMatch(GameClient* Client, const Frpg2ReliableUdpMessage& Message) {
  ...
  if (ServerInstance->GetConfig().SendDiscordNotice_QuickMatch) {
    if (NewMatch->MatchingParams.password().empty()) {
      ...
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::Duel:
        ModeName = "Dual";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::FourPlayerBrawl:
        ModeName = "4 Player Brawl";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::SixPlayerBrawl:
        ModeName = "6 Player Brawl";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::ThreeVersusThree:
        ModeName = "3 v 3";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::ThreeVersusThree_Team:
        ModeName = "Team 3 v 3";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::TwoPlayerBrawl:
        ModeName = "2 Player Brawl";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::TwoVersusTwo:
        ModeName = "2 v 2";
        break;
      case DS3_Frpg2RequestMessage::QuickMatchGameMode::TwoVersusTwo_Team:
        ModeName = "Team 2 v 2";
        break;
      }
