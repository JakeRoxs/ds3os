...
MessageHandleResult DS3_LoggingManager::Handle_RequestNotifyProtoBufLog(GameClient* Client, const Frpg2ReliableUdpMessage& Message) {
  ...
  switch (Request->type()) {
  case DS3_Frpg2RequestMessage::LogType::UseMagicLog:
    Handle_UseMagicLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::ActGestureLog:
    Handle_ActGestureLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::UseItemLog:
    Handle_UseItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::PurchaseItemLog:
    Handle_PurchaseItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::GetItemLog:
    Handle_GetItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::DropItemLog:
    Handle_DropItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::LeaveItemLog:
    Handle_LeaveItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::SaleItemLog:
    Handle_SaleItemLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::StrengthenWeaponLog:
    Handle_StrengthenWeaponLog(Client, Request);
    break;
  case DS3_Frpg2RequestMessage::LogType::VisitResultLog:
    Handle_VisitResultLog(Client, Request);
    break;
