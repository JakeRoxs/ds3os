...
MessageHandleResult DS2_QuickMatchManager::OnMessageReceived(GameClient* Client, const Frpg2ReliableUdpMessage& Message) {
...
MessageHandleResult DS2_QuickMatchManager::Handle_RequestRegisterQuickMatch(GameClient* Client, const Frpg2ReliableUdpMessage& Message) {
  ...
  if (ServerInstance->GetConfig().SendDiscordNotice_QuickMatch) {
    ...
    case DS2_Frpg2RequestMessage::QuickMatchGameMode::QuickMatchGameMode_Blue:
      ModeName = "Blue Sentinel";
      break;
    case DS2_Frpg2RequestMessage::QuickMatchGameMode::QuickMatchGameMode_Brotherhood:
      ModeName = "Brotherhood of Blood";
      break;
    }
