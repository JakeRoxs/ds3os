...
LONG WINAPI DetourTransactionBegin() {
  ...
  _Benign_race_begin_ if (s_nPendingThreadId != 0) {
      ...
      for (o = s_pPendingOperations; o != NULL; o = o->pNext) {
        if (o->fIsRemove) {
          if (cxt.DETOURS_EIP >= (DETOURS_EIP_TYPE)(ULONG_PTR)o->pTrampoline &&
            ...
            cxt.DETOURS_EIP = (DETOURS_EIP_TYPE)((ULONG_PTR)o->pbTarget + detour_align_from_trampoline(o->pTrampoline,
                                                                                                       (BYTE)(cxt.DETOURS_EIP - (DETOURS_EIP_TYPE)(ULONG_PTR)
                                                                                                                                    o->pTrampoline)));
          ...
          if (cxt.DETOURS_EIP >= (DETOURS_EIP_TYPE)(ULONG_PTR)o->pbTarget &&
            ...
            cxt.DETOURS_EIP = (DETOURS_EIP_TYPE)((ULONG_PTR)o->pTrampoline + detour_align_from_target(o->pTrampoline,
                                                                                                      (BYTE)(cxt.DETOURS_EIP - (DETOURS_EIP_TYPE)(ULONG_PTR)
                                                                                                                                   o->pbTarget)));
