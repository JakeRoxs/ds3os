...
void DumpModuleInfo(HMODULE hModule) {
  ...
  PIMAGE_DATA_DIRECTORY pdir = (pinh->OptionalHeader.Magic == IMAGE_NT_OPTIONAL_HDR32_MAGIC)
  ...
  if (pdir[IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR].VirtualAddress != 0 &&
    ...
    PDETOUR_CLR_HEADER pch = (PDETOUR_CLR_HEADER)(pbModule + pdir[IMAGE_DIRECTORY_ENTRY_COM_DESCRIPTOR].VirtualAddress);
