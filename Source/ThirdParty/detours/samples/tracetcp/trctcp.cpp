...
int(WINAPI* Real_WSACancelAsyncRequest)(HANDLE a0) = WSACancelAsyncRequest;

int(WINAPI* Real_WSACancelBlockingCall)(void) = WSACancelBlockingCall;

int(WINAPI* Real_WSACleanup)(void) = WSACleanup;

BOOL(WINAPI* Real_WSACloseEvent)(HANDLE a0) = WSACloseEvent;
...
HANDLE(WINAPI* Real_WSACreateEvent)(void) = WSACreateEvent;
...
BOOL(WINAPI* Real_WSAIsBlocking)(void) = WSAIsBlocking;
...
INT(WINAPI* Real_WSALookupServiceBeginA)(
    ...
    LPHANDLE lphLookup) = WSALookupServiceBeginA;

INT(WINAPI* Real_WSALookupServiceBeginW)(
    LPWSAQUERYSETW lpqsRestrictions,
    DWORD dwControlFlags,
    LPHANDLE lphLookup) = WSALookupServiceBeginW;

INT(WINAPI* Real_WSALookupServiceNextA)(
    HANDLE hLookup,
    DWORD dwControlFlags,
    LPDWORD lpdwBufferLength,
    LPWSAQUERYSETA lpqsResults) = WSALookupServiceNextA;

INT(WINAPI* Real_WSALookupServiceNextW)(
    HANDLE hLookup,
    DWORD dwControlFlags,
    LPDWORD lpdwBufferLength,
    LPWSAQUERYSETW lpqsResults) = WSALookupServiceNextW;

INT(WINAPI* Real_WSALookupServiceEnd)(
    HANDLE hLookup) = WSALookupServiceEnd;
...
BOOL(WINAPI* Real_WSAResetEvent)(HANDLE a0) = WSAResetEvent;
