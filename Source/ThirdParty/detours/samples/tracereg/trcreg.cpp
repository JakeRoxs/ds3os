...
BOOL(WINAPI*
         Real_FlushFileBuffers)(HANDLE hFile) = FlushFileBuffers;
BOOL(WINAPI*
         Real_CloseHandle)(HANDLE hObject) = CloseHandle;

BOOL(WINAPI*
         Real_WaitNamedPipeW)(LPCWSTR lpNamedPipeName, DWORD nTimeOut) = WaitNamedPipeW;
BOOL(WINAPI*
...
DWORD(WINAPI*
          Real_GetCurrentProcessId)(VOID) = GetCurrentProcessId;
VOID(WINAPI*
         Real_GetSystemTimeAsFileTime)(LPFILETIME lpSystemTimeAsFileTime) = GetSystemTimeAsFileTime;

VOID(WINAPI*
         Real_InitializeCriticalSection)(LPCRITICAL_SECTION lpSection) = InitializeCriticalSection;
VOID(WINAPI*
         Real_EnterCriticalSection)(LPCRITICAL_SECTION lpSection) = EnterCriticalSection;
VOID(WINAPI*
         Real_LeaveCriticalSection)(LPCRITICAL_SECTION lpSection) = LeaveCriticalSection;
}
...
BOOL(WINAPI* Real_DeleteFileA)(LPCSTR a0) = DeleteFileA;
...
LONG(WINAPI* Real_RegEnumKeyExA)(HKEY a0,
                                 ...
                                 LPSTR a5,
                                 LPDWORD a6,
                                 struct _FILETIME* a7) = RegEnumKeyExA;
...
LONG(WINAPI* Real_RegEnumKeyExW)(HKEY a0,
                                 ...
                                 LPWSTR a5,
                                 LPDWORD a6,
                                 struct _FILETIME* a7) = RegEnumKeyExW;
...
LONG(WINAPI* Real_RegQueryInfoKeyA)(HKEY a0,
                                    ...
                                    LPDWORD a9,
                                    LPDWORD a10,
                                    struct _FILETIME* a11) = RegQueryInfoKeyA;
...
LONG(WINAPI* Real_RegQueryInfoKeyW)(HKEY a0,
                                    ...
                                    LPDWORD a9,
                                    LPDWORD a10,
                                    struct _FILETIME* a11) = RegQueryInfoKeyW;
