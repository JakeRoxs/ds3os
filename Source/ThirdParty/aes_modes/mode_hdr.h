...
#define rep2_u2(f, r, x) \
  f(0, r, x);            \
  f(1, r, x)
#define rep2_u4(f, r, x) \
  f(0, r, x);            \
  f(1, r, x);            \
  f(2, r, x);            \
  f(3, r, x)
...
#define rep2_d2(f, r, x) \
  f(1, r, x);            \
  f(0, r, x)
#define rep2_d4(f, r, x) \
  f(3, r, x);            \
  f(2, r, x);            \
  f(1, r, x);            \
  f(0, r, x)
...
#define rep3_u2(f, r, x, y, c) \
  f(0, r, x, y, c);            \
  f(1, r, x, y, c)
#define rep3_u4(f, r, x, y, c) \
  f(0, r, x, y, c);            \
  f(1, r, x, y, c);            \
  f(2, r, x, y, c);            \
  f(3, r, x, y, c)
...
#define rep3_d2(f, r, x, y, c) \
  f(1, r, x, y, c);            \
  f(0, r, x, y, c)
#define rep3_d4(f, r, x, y, c) \
  f(3, r, x, y, c);            \
  f(2, r, x, y, c);            \
  f(1, r, x, y, c);            \
  f(0, r, x, y, c)
...
#elif UNIT_BITS == 32
  UNIT_PTR(d)
  [0] = bswap_32(UNIT_PTR(s)[0]);
  UNIT_PTR(d)
  [1] = bswap_32(UNIT_PTR(s)[1]);
  UNIT_PTR(d)
  [2] = bswap_32(UNIT_PTR(s)[2]);
  UNIT_PTR(d)
  [3] = bswap_32(UNIT_PTR(s)[3]);
#else
  UI32_PTR(d)
  [0] = bswap_32(UI32_PTR(s)[0]);
  UI32_PTR(d)
  [1] = bswap_32(UI32_PTR(s)[1]);
  UI32_PTR(d)
  [2] = bswap_32(UI32_PTR(s)[2]);
  UI32_PTR(d)
  [3] = bswap_32(UI32_PTR(s)[3]);
#endif
}
...
#else
  UNIT_PTR(d)
  [0] = bswap_64(UNIT_PTR(s)[0]);
  UNIT_PTR(d)
  [1] = bswap_64(UNIT_PTR(s)[1]);
#endif
}
...
mh_decl void bswap128_block(void* d, const void* s) {
  ...
  t = bswap_32(UNIT_PTR(s)[0]);
  UNIT_PTR(d)
  [0] = bswap_32(UNIT_PTR(s)[3]);
  UNIT_PTR(d)
  [3] = t;
  t = bswap_32(UNIT_PTR(s)[1]);
  UNIT_PTR(d)
  [1] = bswap_32(UNIT_PTR(s)[2]);
  UNIT_PTR(d)
  [2] = t;
#else
  uint64_t t;
