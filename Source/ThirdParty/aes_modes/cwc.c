...
void do_cwc(uint32_t in[], cwc_ctx ctx[1]) {
  ...
  ctx->hash[1] = a[1] * ctx->zval[0] + a[0] * ctx->zval[1];
  ctx->hash[2] = a[2] * ctx->zval[0] + a[1] * ctx->zval[1] + a[0] * ctx->zval[2];
  ctx->hash[3] = a[3] * ctx->zval[0] + a[2] * ctx->zval[1] + a[1] * ctx->zval[2] + a[0] * ctx->zval[3];
  ctx->hash[4] = a[4] * ctx->zval[0] + a[3] * ctx->zval[1] + a[2] * ctx->zval[2] + a[1] * ctx->zval[3] + a[0] * ctx->zval[4];
  ctx->hash[5] = a[5] * ctx->zval[0] + a[4] * ctx->zval[1] + a[3] * ctx->zval[2] + a[2] * ctx->zval[3] + a[1] * ctx->zval[4] + a[0] * ctx->zval[5];
  ...
  v = a[5] * ctx->zval[1] + a[4] * ctx->zval[2] + a[3] * ctx->zval[3] + a[2] * ctx->zval[4] + a[1] * ctx->zval[5]; /* add in r[6] term  */
  f = (v + tp59) - tp59;
  ...
  v = a[5] * ctx->zval[2] + a[4] * ctx->zval[3] + a[3] * ctx->zval[4] + a[2] * ctx->zval[5]; /* add in r[7] term  */
  f = (v + tp59) - tp59;
  ...
  v = a[5] * ctx->zval[3] + a[4] * ctx->zval[4] + a[3] * ctx->zval[5]; /* add in r[8] term  */
  f = (v + tp59) - tp59;
  ...
  v = a[5] * ctx->zval[4] + a[4] * ctx->zval[5]; /* add in r[9] term  */
  f = (v + tp59) - tp59;
...
void add_4(uint32_t l[], uint32_t r[]) {
  ...
  ss = l[2] + r[2] + cc;
  cc = (ss < l[2] ? 1 : ss > l[2] ? 0
                                  : cc);
  l[2] = ss;

  ss = l[1] + r[1] + cc;
  cc = (ss < l[1] ? 1 : ss > l[1] ? 0
                                  : cc);
  l[1] = ss;
                         ...
                         cwc_ctx ctx[1])        /* the mode context             */
{
  ...
  */
  ...
  hh[0] = ((uint32_t)ctx->hash[4]) | (((uint32_t)ctx->hash[5]) << 24);
  hh[1] = (((uint32_t)ctx->hash[2]) >> 16) | (((uint32_t)ctx->hash[3]) << 8);
  hh[2] = (((uint32_t)ctx->hash[1]) >> 8) | ((((uint32_t)ctx->hash[2]) & 0x0000ffff) << 16);
  hh[3] = ((uint32_t)ctx->hash[0]) | (((uint32_t)ctx->hash[1]) << 24);
