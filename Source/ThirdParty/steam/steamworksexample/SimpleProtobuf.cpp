...
bool ProtobufReadRepeatedInteger(const char*& pParsePosition, const char* pParseEnd, uint32 uFieldTag, std::vector<uint64>& vec) {
  return ProtobufReadRepeated_T(pParsePosition, pParseEnd, uFieldTag, vec, &ProtobufReadInteger);
}
...
bool ProtobufReadRepeatedSInteger(const char*& pParsePosition, const char* pParseEnd, uint32 uFieldTag, std::vector<int64>& vec) {
  return ProtobufReadRepeated_T(pParsePosition, pParseEnd, uFieldTag, vec, &ProtobufReadSInteger);
}
...
bool ProtobufReadRepeatedFixed32(const char*& pParsePosition, const char* pParseEnd, uint32 uFieldTag, std::vector<int32>& vec) {
  return ProtobufReadRepeated_T(pParsePosition, pParseEnd, uFieldTag, vec, &ProtobufReadFixed32);
}
...
bool ProtobufReadRepeatedFixed64(const char*& pParsePosition, const char* pParseEnd, uint32 uFieldTag, std::vector<int64>& vec) {
  return ProtobufReadRepeated_T(pParsePosition, pParseEnd, uFieldTag, vec, &ProtobufReadFixed64);
}
...
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, uint64& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, int64& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, uint32& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, int32& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, bool& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
bool ProtobufExtractField_SInteger(const std::string& strProtobuf, uint32 uFieldNumber, int64& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), value, &ProtobufReadSInteger);
}
bool ProtobufExtractField_SInteger(const std::string& strProtobuf, uint32 uFieldNumber, int32& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), value, &ProtobufReadSInteger);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, int64& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), value, &ProtobufReadFixed64);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, uint64& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), value, &ProtobufReadFixed64);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, double& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), value, &ProtobufReadFixed64);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, int32& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), value, &ProtobufReadFixed32);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, uint32& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), value, &ProtobufReadFixed32);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, float& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), value, &ProtobufReadFixed32);
}
bool ProtobufExtractField_String(const std::string& strProtobuf, uint32 uFieldNumber, std::string& value) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_STRING(uFieldNumber), value, &ProtobufReadString);
}

bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<uint64>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int64>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<uint32>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int32>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
bool ProtobufExtractField_Integer(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<bool>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
bool ProtobufExtractField_SInteger(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int64>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), vec, &ProtobufReadRepeatedSInteger);
}
bool ProtobufExtractField_SInteger(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int32>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), vec, &ProtobufReadRepeatedSInteger);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int64>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), vec, &ProtobufReadRepeatedFixed64);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<uint64>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), vec, &ProtobufReadRepeatedFixed64);
}
bool ProtobufExtractField_Fixed64(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<double>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), vec, &ProtobufReadRepeatedFixed64);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<int32>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), vec, &ProtobufReadRepeatedFixed32);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<uint32>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), vec, &ProtobufReadRepeatedFixed32);
}
bool ProtobufExtractField_Fixed32(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<float>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), vec, &ProtobufReadRepeatedFixed32);
}
bool ProtobufExtractField_String(const std::string& strProtobuf, uint32 uFieldNumber, std::vector<std::string>& vec) {
  return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(), PROTOBUF_FIELDTAG_STRING(uFieldNumber), vec, &ProtobufReadRepeatedString);
}
