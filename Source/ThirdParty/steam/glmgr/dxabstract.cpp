...
HRESULT IDirect3D9::CheckDeviceFormat(UINT Adapter, D3DDEVTYPE DeviceType, D3DFORMAT AdapterFormat, DWORD Usage, D3DRESOURCETYPE RType, D3DFORMAT CheckFormat) {
  ...
  DWORD knownUsageMask = D3DUSAGE_RENDERTARGET | D3DUSAGE_DEPTHSTENCIL | D3DUSAGE_DYNAMIC | D3DUSAGE_AUTOGENMIPMAP | D3DUSAGE_QUERY_SRGBREAD | D3DUSAGE_QUERY_FILTER | D3DUSAGE_QUERY_SRGBWRITE | D3DUSAGE_QUERY_POSTPIXELSHADER_BLENDING | D3DUSAGE_QUERY_VERTEXTEXTURE;
  ...
  case D3DFMT_X8R8G8B8:
    ...
    case D3DRTYPE_TEXTURE:
      ...
      case D3DFMT_A16B16G16R16F:
        legalUsage = D3DUSAGE_DYNAMIC | D3DUSAGE_AUTOGENMIPMAP | D3DUSAGE_RENDERTARGET | D3DUSAGE_QUERY_SRGBREAD | D3DUSAGE_QUERY_SRGBWRITE;
  ...
  *ppDecl = NULL;
  ...
  for (const D3DVERTEXELEMENT9* src = pVertexElements; (src->Stream != 0xFF); src++) {
    ...
    case D3DDECLTYPE_FLOAT1:
      elem->m_gldecl.m_datasize = 1;
      elem->m_gldecl.m_datatype = GL_FLOAT;
      elem->m_gldecl.m_normalized = 0;
      bytes = 4;
      break;
    case D3DDECLTYPE_FLOAT2:
      elem->m_gldecl.m_datasize = 2;
      elem->m_gldecl.m_datatype = GL_FLOAT;
      elem->m_gldecl.m_normalized = 0;
      bytes = 8;
      break;
    ...
    case D3DDECLTYPE_SHORT2:
      ...
      elem->m_gldecl.m_datasize = 2;
      elem->m_gldecl.m_datatype = GL_UNSIGNED_SHORT;
...
HRESULT IDirect3DDevice9::SetSamplerState(DWORD Sampler, D3DSAMPLERSTATETYPE Type, DWORD Value) {
  ...
  case D3DSAMP_MAGFILTER:
    samp->m_magFilter = (D3DTEXTUREFILTERTYPE)Value;
    break;
  case D3DSAMP_MINFILTER:
    samp->m_minFilter = (D3DTEXTUREFILTERTYPE)Value;
    break;
  case D3DSAMP_MIPFILTER:
    samp->m_mipFilter = (D3DTEXTUREFILTERTYPE)Value;
    break;
  case D3DSAMP_MIPMAPLODBIAS:
    samp->m_mipmapBias = Value;
    break; // float in sheep's clothing - check this one out
  case D3DSAMP_MAXMIPLEVEL:
    samp->m_maxMipLevel = Value;
    break;
  case D3DSAMP_MAXANISOTROPY:
    samp->m_maxAniso = Value;
    break;
  case D3DSAMP_SRGBTEXTURE:
    samp->m_srgb = Value;
    break;
  case D3DSAMP_SHADOWFILTER:
    samp->m_shadowFilter = Value;
    break;
