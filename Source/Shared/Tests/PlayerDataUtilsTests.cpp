...
enum class DS3_OnlineAreaId : int { None = 0,
                                    Dummy = 1 };
...
struct DS2_PlayerState {
  struct Loc {
    bool has_online_area_id() const { return has; }
...
template <>
struct BonfireEnumFor<FakeState> {
  using type = FakeBonfire;
};

template <>
struct BonfireAccessor<FakeState> {
